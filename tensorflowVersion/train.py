...
from tensorflowVersion.Batch import BatchGenerator
from tensorflowVersion.bilstm_crf import Model
from tensorflowVersion.utils import *
...
print(x_train)
print("train len:", len(x_train))  # 24271
print("test len:", len(x_test))  # 7585
print("word2id len", len(word2id))  # 3917
...
epochs = 31  # 训练的次数（0-30）
batch_size = 32  # 每次从数据中取出32行
#
config = {}
